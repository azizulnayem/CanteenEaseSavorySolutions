...
public class Admin_signupController implements Initializable {
     ...
     @FXML private Button signupbtn;
      ...
      @FXML private TextField name;
        ...
        @FXML private PasswordField mailpassword;
    ...
    {
        Parent tableViewParent = FXMLLoader.load(getClass().getResource("admin_login.fxml"));
    ...
    public void signupbtnpushed(ActionEvent event) throws IOException
    {
        String idtext=id.getText();
         ...
         String confirmedPassword = confirmpassword.getText(); // Get the value of the confirm password field
    
        if (!canteenpasstext.equals(confirmedPassword)) {
        ...
        File file=new File("varsity_database_admin.txt");
            ...
            
        {
           ...
           File file2=new File("admin_info.txt");
          ...
          else
          {
               ...
               File file3=new File("admin_info.txt");
